...
|-------------|-----------|-------------------|----------|
| `chat_fast` | `/api/chat` (mode Rapide) | gpt-5-mini (web_search OFF) — UNE réponse directe, sans outil ni split ; le prompt du mode interdit toute source non vérifiée (migration `0042`) | Tous |
