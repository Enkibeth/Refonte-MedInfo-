-- 0010 — Durcissement base (advisors Supabase), 0 impact réglementaire / fonctionnel.
-- NB ledger prod : appliquée en prod sous le nom `0008_db_hardening` (avant les migrations
-- Stripe 0007_subscriptions/0008_billing_events) ; renumérotée 0010 côté repo pour éviter la
-- collision de préfixe avec le lot billing déjà mergé sur dev.
