-- 0007 — RAG : sémantique OR pour la requête plein-texte de match_rag_chunks.
-- Capture dans le repo de la migration déjà appliquée en prod (`0007_rag_match_or_semantics`),
